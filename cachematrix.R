...
## makeCacheMatrix create a special "matrix", which is really a list containing a funtion to
...
## The following function calculates the inverse of the specail "matrix" created with the above function. However, it first checks to see if the inverse has already been calculated. If so, it gets the inverse from the cache and skips the computation. Otherwise, it calculates the inverse of the matrix and sets the value in the cache via setinverse function.
